import{r as i,s as a,j as n,b as m,B as l,H as x}from"./index-d4476aa7.js";import{m as p}from"./index.esm-29b53e51.js";const h=(o,t=!0)=>{const e=i.useRef(null);return i.useEffect(()=>{const r=s=>{e.current&&!e.current.contains(s.target)&&o(s)};return document.addEventListener("click",r,t),()=>document.removeEventListener("click",r,t)},[o,t]),e},f=a.div`
  position: fixed;
  top: 50%;
  left: 50%;
