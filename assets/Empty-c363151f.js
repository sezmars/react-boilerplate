import{d as i,s as a,j as r,e as m,H as p,B as l}from"./index-990f8a1f.js";import{m as x}from"./index.esm-443ac182.js";const h=(o,t=!0)=>{const e=i.useRef(null);return i.useEffect(()=>{const n=s=>{e.current&&!e.current.contains(s.target)&&o(s)};return document.addEventListener("click",n,t),()=>document.removeEventListener("click",n,t)},[o,t]),e},v=a.div`
  position: fixed;
  top: 50%;
  left: 50%;
